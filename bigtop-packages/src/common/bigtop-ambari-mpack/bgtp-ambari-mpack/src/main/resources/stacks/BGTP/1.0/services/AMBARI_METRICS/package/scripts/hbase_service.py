...
def hbase_service(
  ...
  action = 'start'): # 'start' or 'stop' or 'status'
    ...
    if action == 'start':
      ...
      Execute(format("{sudo} wget http://bigtop-snapshot.s3.amazonaws.com/centos-7/x86_64/bigtop-stack-binary/phoenix-hbase-compat-2.4.1-5.1.2.jar -P /usr/lib/ambari-metrics-collector")
      )
      Execute(format("{sudo} wget http://bigtop-snapshot.s3.amazonaws.com/centos-7/x86_64/bigtop-stack-binary/phoenix-core-5.1.2.jar -P /usr/lib/ambari-metrics-collector")
      )
