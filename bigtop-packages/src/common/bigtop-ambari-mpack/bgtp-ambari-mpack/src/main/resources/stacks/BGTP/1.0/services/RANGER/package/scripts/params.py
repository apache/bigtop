...
ranger_admin_services_file='/usr/lib/ranger-admin/ews/ranger-admin-services.sh'
...
ugsync_conf='/etc/ranger/usersync/conf'
...
ranger_tagsync_conf='/usr/lib/ranger-tagsync/conf'
...
ugsync_cred_lib_only = os.path.join(usersync_home,"lib","*")
ugsync_cred_lib = '%s:/usr/lib/hadoop/lib/*' % ugsync_cred_lib_only
cred_lib_path_only = os.path.join(ranger_home,"cred","lib","*")
cred_lib_path = '%s:/usr/lib/hadoop/lib/*' % cred_lib_path_only
...
tagsync_cred_lib_only = os.path.join(ranger_tagsync_home, "lib", "*")
tagsync_cred_lib = '%s:/usr/lib/hadoop/lib/*' % tagsync_cred_lib_only
