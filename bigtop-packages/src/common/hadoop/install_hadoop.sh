...
chmod 644 ${HADOOP_DIR}/*.jar ${MAPREDUCE_DIR}/*.jar ${HDFS_DIR}/*.jar ${YARN_DIR}/*.jar ${YARN_DIR}/timelineservice/*.jar 
...
for DIR in ${HADOOP_DIR} ${HDFS_DIR} ${YARN_DIR} ${MAPREDUCE_DIR} ${HTTPFS_DIR} ${YARN_DIR}/timelineservice ; do
  (cd $DIR &&
   rm -fv *-sources.jar
