...
class TestPackagesPseudoDistributedFileContents extends TestPackagesBasics {
  public TestPackagesPseudoDistributedFileContents(String pkgName, Node pkgGolden) {
