...
package org.apache.bigtop.itest.hadoop.gridgain
...
class TestGridGainHadoop {
  static private Log LOG = LogFactory.getLog(Object.class)

  static Shell sh = new Shell("/bin/bash -s")

  static String hadoopClassPath = "/usr/lib/gridgain-hadoop/libs/*:/usr/lib/gridgain-hadoop/libs/gridgain-hadoop/*"
